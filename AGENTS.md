...
- Use `scripts/Invoke-ControlledZapScan.ps1` apenas em modo de planejamento até que orçamento e execução sejam autorizados explicitamente; o modo de execução exige a imagem fixada e a confirmação literal documentada.
